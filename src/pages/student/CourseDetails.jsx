...
const CourseDetails = () => {
  ...
  const {allCourses, calculateRating,calculateNoOfLectures, calculateCoursesDuration, calculateChapterTime } = useContext(AppContext)
  ...
  return courseData ? (
    ...
    <div className='flex md:flex-row flex-col flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='absolute top-0 left-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b from-cyan-100/70'></div>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        {/* review and rating */}
          ...
          <div className="flex items-center space-x-2 mt-1 pt-3 pb-1 text-sm">
                  ...
                  <p>{courseData.enrolledStudents.length} { courseData.courseRatings.length
